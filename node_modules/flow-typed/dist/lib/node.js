...
var fs = exports.fs = {
  appendFile: function appendFile(path, data) {
    return new Promise(function (res, rej) {
      node_fs.appendFile(path, data, function (err) {
        if (err) {
          rej(err);
        } else {
          res();
  ...
  open: function open(path, flags, mode) {
    return new Promise(function (res, rej) {
      node_fs.open(path, flags, mode, function (err, fd) {
        if (err) {
          rej(err);
        } else {
          res(fd);
