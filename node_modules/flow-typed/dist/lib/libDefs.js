...
function getLibDefNamespaces(defsDirPath) {
  ...
  return regeneratorRuntime.async(function getLibDefNamespaces$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        ...
        case 3:
          defsDirItems = _context15.sent;
          _context15.next = 6;
          return regeneratorRuntime.awrap(P.all(defsDirItems.map(function _callee6(item) {
        ...
        case 6:
          return _context15.abrupt("return", namespaces);
...
function getLocalLibDefs(validationErrs) {
  ...
  return regeneratorRuntime.async(function getLocalLibDefs$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 4:
          namespaces = _context17.sent;
          libDefs = [];
          _context17.next = 8;
          return regeneratorRuntime.awrap(P.all(namespaces.map(function _callee7(ns) {
            var nsLibdefs;
        ...
        case 8:
          return _context17.abrupt("return", libDefs);
...
function getCacheLibDefs() {
  ...
  return regeneratorRuntime.async(function getCacheLibDefs$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        ...
        case 4:
          return _context18.abrupt("return", getLibDefs(CACHE_REPO_DEFS_DIR, validationErrs));
...
function getCacheLibDefVersion(libDef) {
  ...
  return regeneratorRuntime.async(function getCacheLibDefVersion$(_context19) {
    while (1) {
      switch (_context19.prev = _context19.next) {
        ...
        case 6:
          latestCommitHash = _context19.sent;
          return _context19.abrupt("return", latestCommitHash.substr(0, 10) + "/" + (libDef.pkgName + "_" + libDef.pkgVersionStr + "/") + ("flow_" + libDef.flowVersionStr));
