    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.prev = 3;
          _context3.next = 6;
          return regeneratorRuntime.awrap(_node.child_process.spawnP(gitPath, ["commit", "-a", "-m", message], { cwd: dirPath }));
...
function getDiff() {
  var gitPath, _ref, _commit, _ref2, stdout;
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.prev = 3;
          _context5.next = 6;
          return regeneratorRuntime.awrap(_node.child_process.spawnP(gitPath, ['merge-base', 'origin/master', 'HEAD']));

        case 6:
          _ref = _context5.sent;
          _commit = _ref.stdout;
          _context5.next = 10;
          return regeneratorRuntime.awrap(_node.child_process.spawnP(gitPath, ['diff', '--name-only', _commit.replace('\n', '')]));
